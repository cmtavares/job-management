package br.com.carlostavares.gestao_vagas.modules.candidate.entities;
...
public class CandidateEntity {
    ...
    @Schema(example = "Daniel Rodrigues", requiredMode = RequiredMode.REQUIRED, description = "Nome do candidato")
    private String name;
